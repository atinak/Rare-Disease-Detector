...
class OrphanetDataProcessor:
    ...
    def __init__(self, data_dir: str = "../data"):
        ...
        self.external_ref_features = None  # No longer used
    ...
    def load_data(self, file_path: str) -> pd.DataFrame:
        ...
        try:
            ...
            #CRITICAL: Replace 'N/A' strings with actual NaN *before* doing anything else
        ...
        for col_num in range(4, 6):
          ...
          for inheritance_item in inheritance_list:
            inheritance_data.append({
              'OrphaCode': orpha_code,
              'DiseaseName': disease_name,
              'TypeOfInheritance': inheritance_item.get('TypeOfInheritance', '') #Using .get()
            })
